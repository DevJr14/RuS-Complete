...
using RuS.Client.Infrastructure.Authentication;
using RuS.Client.Infrastructure.Managers;
using RuS.Client.Infrastructure.Managers.Preferences;
...
using RuS.Client.Infrastructure.Managers.ExtendedAttribute;
using RuS.Domain.Entities.ExtendedAttributes;
using RuS.Domain.Entities.Misc;
using Toolbelt.Blazor.Extensions.DependencyInjection;

namespace RuS.Client.Extensions
{
